#  ANAS LIKE API SRC UID PASSWORD 
# POWERED BY : @ANAS
# CHANNEL : @ANAS
...
async def generate_jwt_token(uid, password):
    ...
    try:
        ...
        url = f"https://jwt-rho-five.vercel.app/api/token?uid={uid}&password={encoded_password}"
...
def reset_cache():
    ...
    global liked_cache
    liked_cache.clear()
    return jsonify({"message": "Cache cleared", "credit": "@ANAS_GMR"})
